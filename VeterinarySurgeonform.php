...
//
 try {
       ...
       // $mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
        ...
        $mail->Subject = 'Registration as Vetrinary Surgeon';
...
<head>
	...
	<title>vetrinarySurgon</title>
	<link rel="stylesheet" type="text/css" href="veterinarySurgeonform.css">
</head>
<body class="body">
<table>
	<tr>
	    ...
	    <td height="600px">
	   	<h1>Veterinary Surgeon </h1>
	   	<form name="frmveterinarySurgeon" method="post" action="#" enctype="multipart/form-data">
		<p>Name</p>
		...
		<textarea class="RegInput"  name="txtaddress" placeholder="Address"></textarea><br>
		 <input type="submit" class="signupsubmit" name="btnVsubmit" value="SUBMIT"><br><br>
